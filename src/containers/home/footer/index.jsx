                    ...
                    <div className="col-xl-4 col-md-6 col-12 pt-4 pl-3 border border-dark">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a  rel="noopener noreferrer" className="footer-link" style={{display:'inline-block',marginLeft: 20}} target="_blank" href={'https://t.me/khaajoo'}>09123456789</a>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <a  rel="noopener noreferrer" className="footer-link" style={{display:'inline-block',marginLeft: 20}} target="_blank" href={'mailto:pars.pariz@gmail.com'}>pars.pariz@gmail.com</a>
                            </div>
                            <div>
                                <img src={insta} alt="" style={{width: 30,  marginBottom:4}}/>
                                <a  rel="noopener noreferrer" className="footer-link" style={{display:'inline-block',marginLeft: 20}} target="_blank" href={'https://www.instagram.com'}>instagram</a>
                            </div>
                            <div>
                                <img src={map} alt="" style={{width: 30,  marginBottom:4}}/>
                                <a  rel="noopener noreferrer" className="footer-link" style={{display:'inline-block',marginLeft: 20}} target="_blank" href={'http://maps.google.com/?q=35.702104,51.403790'}>google map</a>
                            </div>
                        </div>
                    </div>
